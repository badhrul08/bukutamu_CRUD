			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form>
						...
						<div class="form-group">
							<label class="control-label mb-10" for="No_Hp">No_Hp</label>
							<input type="text" class="form-control" name="input_no" id="No_Hp" placeholder="Masukkan Nomor Handphone">
						</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form>
						...
						<div class="form-group">
							<label class="control-label mb-10" for="edit_nama">Nama</label>
	...
	<script>
		...
		$(document).ready(function () {
					...
					success: function (data) {
						...
						for (i = 0; i < data.length; i++) {
							html += '<tr id="' + data[i].id_tamu + '">' +
								...
								'<td>' + data[i].waktu + '</td>' +
								'<td>' +
								'<button class="btn btn-xs btn-primary" style="padding-left: 10px;padding-right: 10px;" data-toggle="modal" data-target="#form-edit" id="btn-edit" data-id="' + data[i].id_tamu + '" data-nama="' + data[i].nama + '" data-jk="' + data[i].jenis_kelamin + '" data-jk="' + data[i].jenis_kelamin + '" data-alamat="' + data[i].alamat + '" data-No_Hp="' + data[i].No_Hp + '"> <i class="fa fa-pencil"></i></button> ' +
			...
			$('#btn-tambah').click(function () {
				var arg = {
					resultFunction: function (result) {
						...
						// document.getElementById("input_No_Hp").innerHTML = array_tamu[3];
			...
			$('#form-tambah').on('hidden.bs.modal', function (e) { // Ketika Modal Dialog di Close / tertutup
				$('#form-tambah #nama, #form-tambah #alamat, #form-tambah #No_Hp').val('') // Clear inputan menjadi kosong
			})
		})
